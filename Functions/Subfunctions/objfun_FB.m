function OBJ=objfun_FB(p,tV,tI,ton1_sp,toff1_sp,ton1_tr,toff1_tr,tVr,tIr,tTauOn,tTauOff,tTauInact,tTauRecov,...
    tIPeak,tIss,tRatio,iChR2fun_sp,iChR2fun_2p,TauDAfun,powerb,tend_sp,tend_tr,incl_tr_flag,CF,pos_nantargets,options)
try
    if incl_tr_flag
        % Taurecov
    ...
    for io=1:length(tV)
        ...
        Features=Extract_feat(to,iChR2_sp,toff1_sp(io)-ton1_sp(io),ton1_sp(io),options.nrr_featextr,options.plot_featextr);
